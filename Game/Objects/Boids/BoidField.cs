...
namespace OpenGLTest.Game.Objects.Boids
{
    public class BoidField : GameObject
    {
        ...
        public BoidField(int _predatorCount = 3, int _boidCount = 100, float _baseSpeed = 5) : base(false)
        {
            ...
            {
                int xPos = rand.Next(-(Engine.mainDriver.currentWindowWidth / 2), (Engine.mainDriver.currentWindowWidth / 2) + 1);
                int yPos = rand.Next(-(Engine.mainDriver.currentWindowHeight / 2), (Engine.mainDriver.currentWindowHeight / 2) + 1);
                ...
                Boid newBoid = new Boid(i < _predatorCount, xPos, yPos, velocity);
        ...
        {
            int width = Engine.mainDriver.currentWindowWidth;
            int height = Engine.mainDriver.currentWindowHeight;
