    ...
    public class Material
    {
        ...
        public static Material Create(Shader _shader, Color _mainColor, ITexture _mainTexture = null, ITexture _normalTexture = null, bool _useLinearFiltering = false, float _normalScale = 1)
        {
            if (blankTexture == null)
                blankTexture = ResourceManager.Instance.LoadTexture(ProjectSettings.GetEngineResourcePath("Textures/BlankTexture.png"));

            if (blankNormal == null)
                blankNormal = ResourceManager.Instance.LoadTexture(ProjectSettings.GetEngineResourcePath("Textures/BlankNormal.png"), true);
        ...
        {
            return Create(_shader, _color, ResourceManager.Instance.LoadTexture(ProjectSettings.GetEngineResourcePath("Textures/Circle.png")));
        }
