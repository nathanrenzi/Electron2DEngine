    ...
    public abstract class Game
    {
        ...
        public void Run(Settings settings)
        {
            ...
            if (ProjectSettings.ShowElectron2DSplashscreen)
            {
                ...
                Texture2D splashscreenTexture = TextureFactory.Load(ProjectSettings.GetEngineResourcePath("Textures/Electron2DSplashscreen.png"), true);
                ...
                AudioInstance splashscreenAudio = AudioSystem.CreateInstance(ProjectSettings.GetEngineResourcePath("Audio/Electron2DRiff.mp3"), volume: 0.3f);
