...
namespace Electron2D.UserInterface
{
    public class TextFieldDef
    {
        ...
        public bool WaitForEnterToUpdate;
        ...
        /// <param name="waitForEnterToUpdate">Should the text updated event wait to be called until enter is pressed?</param>
        public TextFieldDef(int caretWidth, int sizeX, int sizeY, Vector4 textAreaPadding, FontGlyphStore textFont, Material textMaterial, 
            ...
            SlicedPanelDef backgroundPanelDef = null, bool waitForEnterToUpdate = false)
        {
            ...
            WaitForEnterToUpdate = waitForEnterToUpdate;
